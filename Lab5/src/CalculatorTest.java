...
public class CalculatorTest {
    ...
    public void calculateThreeTokensTestValidDivide() throws AssertException
    {
    	try
        {
            int result = Calculator.calculateThreeTokens(new String[] {"100", "/", "10"});
            Assert.assertEquals(10, result);
        }
        catch (Exception e)
        {
    ...
    public void calculateThreeTokensTestInvalidCommand() throws AssertException
    {
    	try
        {
            Calculator.calculateThreeTokens(new String[] {"5", "plus", "5"});
            Assert.fail("Illegal expression did not throw an Exception");
        }
        catch (CalculatorException e)
        {
    ...
    public void executeTestInvalidTokenLength() throws AssertException
    {
    	try
        {
            Calculator.execute(new String[] {"5", "-", "5", "+", "3"});
            Assert.fail("Illegal expression did not throw an Exception");
        }
        catch (CalculatorException e)
        {
    ...
    {
    	String result = Calculator.parseAndExecute("5 / zero");
    ...
    {
    	String result = Calculator.parseAndExecute("5 - 5 + 5");
